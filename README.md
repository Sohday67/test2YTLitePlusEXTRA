...
- [YouHideIsland](https://github.com/middsave/YouHideIsland) - Prevents Dynamic Island / Now Playing from appearing while YouTube is in the foreground
- [YTSkipSilence](https://github.com/Sohday67/test5silence) - Adds a YTVideoOverlay button that skips long silences in videos
